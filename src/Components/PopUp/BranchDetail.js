...
export default function Edit(props){
    ...
    const [state, setState] = useState({
        roleid:'', rolename:'',createdUser:'',createdTime:''
    })
    ...
    useEffect(()=>{
        if(props.name=="EDIT BRANCH" || props.name=="DETAIL BRANCH"){
            setLoading(true)
            var config = {
                method: 'get',
    ...
    return(
        <div style={{display:'flex', justifyContent:'center', alignItems:'center',position:'fixed',zIndex:100, top:0, bottom:0, left:0, right:0, background:'rgba(0,0,0,0.3)'}}>
            ...
            <div style={{position:'relative',background:'white',textAlign:'center', width:"700px", height:"270px", borderRadius:'10px'}}>
                ...
                <div style={{padding:'10px', marginLeft:"20px", marginTop:"10px", display:'flex', alignItems:'center'}}>
                    ...
                    <div style={{textAlign:'left'}}>
                        ...
                        <br></br>
                        <span style={{ marginLeft:'20px',fontFamily:'Poppinsbold',color:'#3bbad6', fontWeight:'bold', fontSize:"12px"}}>Edit by {state.createdUser+" "+state.createdTime}</span>
                    </div>
                </div>
                <div style={{boxShadow: 'rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px',padding:'20px',margin:'auto', width:'650px', height:'170px', background:'#e5f4f8', border:'1px solid gray', borderRadius:'5px'}}>
                    <div style={{position:'relative',display:'flex',alignItems:'center',justifyContent:'space-between',fontFamily:'Poppinsbold', color:'#575757', fontSize:'20px'}}>
                        ...
                        <input readOnly value={state.roleid} name="roleid"  style={{background:'#c4c4c4',width:'400px', height:'50px', borderRadius:'10px',border:"1px solid #3bbad6", paddingLeft:'5px', paddingRight:'5px'}}></input>
                    </div>
                    <br></br>
                    <div style={{position:'relative',display:'flex',alignItems:'center',justifyContent:'space-between',fontFamily:'Poppinsbold', color:'#575757', fontSize:'20px'}}>
                        ...
                        <input readOnly value={state.rolename} name="rolename"  style={{background:'#c4c4c4',width:'400px', height:'50px', borderRadius:'10px',border:"1px solid #3bbad6",paddingLeft:'5px', paddingRight:'5px'}}></input>
                    </div>
                </div>
