...
export default function UserRole(props){
    ...
    useEffect(()=>{
        var config = {
            method: 'get',
            url: Api()+'/credential/branch?moduleId=ANT&ordertype=asc&orderby=roleName&perpage=10&page=1&filter=roleName like \'%01\'',
            headers: { 
    ...
    return (
        <div>
            <Page1 data={data} judul={'MasterBranch'} onClick={handleCuy} filter={filter} info={info}></Page1>
